...
public class MiImageLoader  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options = new DisplayImageOptions.Builder()
                .build();
        imageLoader.displayImage("https://fugacious-bits.000webhostapp.com/loading.jpg", miimagen, options, new ImageLoadingListener() {
            @Override
            ...
            public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                ...
                miimagen.setScaleType(ImageView.ScaleType.FIT_XY);//fit-xy es que se deformara la imagen
            }
